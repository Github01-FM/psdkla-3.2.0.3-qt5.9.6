...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Sat Mar 14 18:52:05 CST 2020
 * Configured by     : Open Embedded
 * Target system     : linux hzhh200x 4.4.0-31-generic #50~14.04.1-ubuntu smp wed jul 13 01:07:32 utc 2016 x86_64 x86_64 x86_64 gnulinux 
 */
 ...
 */
#define OSNAME "linux"		/**/
#define OSVERS "4.4.0-31-generic"		/**/
 ...
 */
/*#define ARCHLIB "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/5.22.1"		/ **/
/*#define ARCHLIB_EXP "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/5.22.1"		/ **/
 ...
 */
#define BIN "${STAGING_DIR_NATIVE}/usr/bin/perl-native"	/**/
#define BIN_EXP "${STAGING_DIR_NATIVE}/usr/bin/perl-native"	/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/5.22.1"		/**/
#define PRIVLIB_EXP "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/5.22.1"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
/*#define SITEARCH "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/site_perl/5.22.1"		/ **/
/*#define SITEARCH_EXP "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/site_perl/5.22.1"		/ **/
 ...
 */
#define SITELIB "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/site_perl/5.22.1"		/**/
#define SITELIB_EXP "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/site_perl/5.22.1"		/**/
#define SITELIB_STEM "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/site_perl"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
/*#define PERL_VENDORARCH "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/vendor_perl/5.22.1"		/ **/
/*#define PERL_VENDORARCH_EXP "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/vendor_perl/5.22.1"		/ **/
 ...
 *	be tacked onto this variable to generate a list of directories to search.
 */
#define PERL_VENDORLIB_EXP "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/vendor_perl/5.22.1"		/**/
#define PERL_VENDORLIB_STEM "${STAGING_DIR_NATIVE}/usr/lib/perl-native/perl/vendor_perl"		/**/
 ...
 *	some shell.
 */
#define STARTPERL "#!${STAGING_DIR_NATIVE}/usr/bin/perl-native/perl"		/**/
