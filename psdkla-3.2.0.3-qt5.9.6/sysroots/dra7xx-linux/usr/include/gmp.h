...
#define __GMP_CFLAGS "-O2 -pedantic -fomit-frame-pointer  -isystem${TOOLCHAIN_PATH}/arm-linux-gnueabihf/include  -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/home/user01/zzp/g5r2/yocto-layers/build/arago-tmp-external-linaro-toolchain/work/armv7ahf-neon-linux-gnueabi/gmp/6.1.0-r0=/usr/src/debug/gmp/6.1.0-r0 -fdebug-prefix-map=${STAGING_DIR_NATIVE}= -fdebug-prefix-map=${STAGING_DIR_HOST}= "
